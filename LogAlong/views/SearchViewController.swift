...
class SearchViewController: UIViewController, UIGestureRecognizerDelegate, FViewControllerDelegate, UIPopoverPresentationControllerDelegate, UIScrollViewDelegate {
    ...
    private func createSwitches() {
        ...
        timeSwitch = UISwitch(frame: CGRect(x: 0, y: 0, width: 60, height: entryHeight * 0.6))
        timeSwitch.addTarget(self, action: #selector(onAllTimeClick), for: .valueChanged)
        valueSwitch = UISwitch(frame: CGRect(x: 0, y: 0, width: 60, height: entryHeight * 0.6))
